...
void sendDataToOpenGL()
{
    ...
    texture.setupTexture("resources/dog/dog_01.jpg");
...
void paintGL(void)  //always run
{
    ...
    glm::mat4 projectionMatrix = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 1.0f, 20.0f);
...
//    texture.bind(0);
    glDrawElements(GL_TRIANGLES, (GLsizei)dog.indices.size(), GL_UNSIGNED_INT, 0);
//    texture.unbind();
//    shader.setInt("dogTexture", 0);
}
